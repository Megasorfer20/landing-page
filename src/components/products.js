  ...
  return (
    <div className="Products">
      ...
      <div className="allMedia">
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto1)  }}>
          <img src={tonicoMechudosFoto1} alt="Tónico Mechudos" />
        </button>
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto2)  }}>
          <img src={tonicoMechudosFoto2} alt="Tónico Mechudos" />
        </button>
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto3)  }}>
          <img src={tonicoMechudosFoto3} alt="Tónico Mechudos" />
        </button>
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto4)  }}>
          <img src={tonicoMechudosFoto4} alt="Tónico Mechudos" />
        </button>
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto5)  }}>
          <img src={tonicoMechudosFoto5} alt="Tónico Mechudos" />
        </button>
        <button className="img-container" onClick={()=>{ chamgePhotoHandler(tonicoMechudosFoto6)  }}>
